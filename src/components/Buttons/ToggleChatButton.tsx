...
export default function ToggleChatButton() {
  ...
  let obj = {isChatWindowOpen:false, setIsChatWindowOpen:(e) => alert('hi'),conversation:false, hasUnreadMessages:false};
  const { isChatWindowOpen, setIsChatWindowOpen, conversation, hasUnreadMessages } = obj;//useChatContext();
