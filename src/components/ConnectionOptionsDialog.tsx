...
import { inputLabels, Settings } from '../state/settingsReducer';
          ...
          <Grid item sm={6} xs={12}>
            ...
            <FormControl className={classes.formControl}>
              ...
              <Select
                ...
                value={withDefault('collaboration')}
